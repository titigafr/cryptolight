...
import bittrex.EncryptionUtility;
import bittrex.ReconnectionAttemptsExceededException;
...
public class Bittrex {
	...
	private String generateUrlParameters(HashMap<String, String> parameters) { // Returns a String with the key-value pairs formatted for UR
